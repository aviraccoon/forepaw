...
Observation works on all three platforms. Actions are fully implemented on macOS and Windows; Linux has stubbed actions (clear error messages, not crashes).
